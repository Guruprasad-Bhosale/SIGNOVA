"""
Phase 19 Human Annotations Ingestion, Authenticity & Lifecycle Unit Tests.
...
- Review state management (ANNOTATION_IN_PROGRESS, REVIEW_PENDING, VERIFIED, REJECTED).
...
def test_valid_human_annotation_with_authenticated_provenance():
    ...
    ann = VideoAnnotation(
        annotation_id="ann_p19_001",
        sample_id="vid_p19_001",
...
def test_unauthenticated_anonymous_annotation_rejected():
    ann = VideoAnnotation(
        annotation_id="ann_p19_002",
        sample_id="vid_p19_002",
...
def test_rejected_annotation_is_not_training_eligible():
    ann = VideoAnnotation(
        annotation_id="ann_p19_003",
        sample_id="vid_p19_003",
        annotator_id="annotator_isl_expert_01",
        is_temporally_aligned=False,
        glosses=[],
        provenance_id="prov_delhi_session_01",
...
def test_pending_review_and_in_progress_lifecycle_tracking():
    ann_draft = VideoAnnotation(
        annotation_id="ann_p19_004",
        sample_id="vid_p19_004",
        annotator_id="annotator_isl_expert_01",
        is_temporally_aligned=True,
        glosses=["THANK_YOU"],
        provenance_id="prov_delhi_session_01",
    ...
    ann_pending = VideoAnnotation(
        annotation_id="ann_p19_005",
        sample_id="vid_p19_005",
        annotator_id="annotator_isl_expert_01",
        is_temporally_aligned=True,
        glosses=["WELCOME"],
        provenance_id="prov_delhi_session_01",
