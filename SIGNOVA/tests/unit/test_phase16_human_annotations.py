"""
Phase 16 Human Annotations Ingestion and Validation Unit Tests.
...
def test_valid_human_annotation_with_distinct_signer_and_annotator():
    ...
    ann = VideoAnnotation(
        annotation_id="ann_p16_001",
        sample_id="vid_p16_001",
...
def test_rejected_annotation_is_not_training_eligible():
    ann = VideoAnnotation(
        annotation_id="ann_p16_002",
        sample_id="vid_p16_002",
        annotator_id="annotator_isl_expert_01",
