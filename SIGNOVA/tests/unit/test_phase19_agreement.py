"""
Phase 19 Independent Double Annotation & Agreement Unit Tests.
...
def test_independent_double_annotation_pair_evaluation():
    ...
    annots = {
        "p19_sample_01": [
            VideoAnnotation("a1", "p19_sample_01", "annot_expert_1", False, ["NAMASTE", "WELCOME"]),
            VideoAnnotation("a2", "p19_sample_01", "annot_expert_2", False, ["NAMASTE", "WELCOME"]),
        ]
    }
