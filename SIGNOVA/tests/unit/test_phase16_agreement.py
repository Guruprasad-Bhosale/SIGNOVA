"""
Phase 16 Independent Double-Annotation & Agreement Unit Tests.
...
def test_independent_double_annotation_agreement():
    ...
    annots = {
        "p16_sample_01": [
            VideoAnnotation("a1", "p16_sample_01", "annot_expert_1", False, ["NAMASTE", "WELCOME"]),
            VideoAnnotation("a2", "p16_sample_01", "annot_expert_2", False, ["NAMASTE", "WELCOME"]),
        ]
    }
