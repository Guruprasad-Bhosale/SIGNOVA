"""
Phase 15 Readiness Summary & Automation Audit Unit Tests.

Validates:
- Dynamic generation of phase15_readiness_summary without hardcoded supervision states.
...
def test_dynamic_readiness_summary_generation(tmp_path):
    ...
    orch = Phase15Orchestrator(annotations_dir=pilot_dir)
